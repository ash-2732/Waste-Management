        ...
        <div className="container mx-auto px-4 py-16">
          <section className="text-center mb-20">
            ...
            {!auth.user ? (
              <>
                <Link
                  to={"/login"}
                  className="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-full text-lg px-6 py-3 text-center inline-flex items-center"
                >
                  Get Started
          ...
          <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
            ...
            <div className="grid md:grid-cols-4 gap-6 font-medium">
              ...
              <ImpactCard title="Reports Submitted" value={waste?.length} icon={MapPin} />
